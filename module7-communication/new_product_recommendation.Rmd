...
models_tbl <- read_rds("../models/parsnip_models_tbl.rds") |> 
  mutate(model = map(model, bundle::unbundle))
```
...
Trigger, Over Mountain with Aluminum Frame: \$2,985

Slice, Triathalon with Aluminum Frame: \$2,438
...
2.  Slice, Triathlon with Aluminum Frame: \$2,438
